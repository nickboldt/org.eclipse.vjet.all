 ...
 *******************************************************************************/
vjo.ctype("org.eclipse.vjet.vsf.utils.logging.RootLogger")
.inherits("org.eclipse.vjet.vsf.utils.logging.Logger")
.protos({
	...
	initializeGlobalHandlers: function(){
		org.eclipse.vjet.vsf.utils.logging.LogManager.getLogManager().initializeGlobalHandlers();
	}
})
.endType();
