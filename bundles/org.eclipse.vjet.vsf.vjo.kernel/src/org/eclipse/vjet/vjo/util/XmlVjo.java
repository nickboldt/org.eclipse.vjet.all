...
//NativeJsProxy for vjo.util.XmlVjo.js
...
public class XmlVjo extends NativeJsProxy {
    ...
    @AExclude
    public XmlVjo(Scriptable nativeObj){
        super(nativeObj);
    }

    /** internal use only */
    protected XmlVjo(Object ...args){
        super(args);
    }
    ...
    public static Object xml2vjo(String xml, String typeName) {
        return callStaticWithName("vjo.util.XmlVjo", "xml2vjo", Object.class, xml, typeName);
    }
