...
public class FormJsr extends JsObj {
    ...
    private static final JsObjData S = 
        new JsObjData("vjo.dsf.document.Form", FormJsr.class, "Form");
    ...
    protected FormJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
        super(cmpMeta, isInstance, args);
    }

    public static JsFunc<? extends HTMLFormElementJsr> get(String psName){
        return call(S, HTMLFormElementJsr.class, "get").with(psName);
    }

    public static JsFunc<? extends HTMLFormElementJsr> get(IValueBinding<String> psName){
        return call(S, HTMLFormElementJsr.class, "get").with(psName);
    }

    public static JsFunc<? extends HTMLElementJsr> getElem(String psFormName, String psElemName){
        return call(S, HTMLElementJsr.class, "getElem").with(psFormName, psElemName);
    }

    public static JsFunc<? extends HTMLElementJsr> getElem(IValueBinding<String> psFormName, IValueBinding<String> psElemName){
        return call(S, HTMLElementJsr.class, "getElem").with(psFormName, psElemName);
    }
    ...
    public static JsTypeRef<FormJsr> prototype = new JsTypeRef<FormJsr>(S);
}