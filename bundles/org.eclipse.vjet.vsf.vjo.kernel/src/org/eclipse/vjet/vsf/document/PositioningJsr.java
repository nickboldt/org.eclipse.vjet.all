...
public class PositioningJsr extends JsObj {
    ...
    private static final JsObjData S = 
        new JsObjData("vjo.dsf.document.Positioning", PositioningJsr.class, "Positioning");
    ...
    public static JsFunc<Integer> getOffsetLeft(Object poElem){
        return call(S, Integer.class, "getOffsetLeft").with(poElem);
    }

    public static JsFunc<Integer> getOffsetTop(Object poElem){
    ...
    public static JsFunc<Object> getEventLeftTop(MouseEventJsr poEvent){
        return call(S, Object.class, "getEventLeftTop").with(poEvent);
    }

    public static JsFunc<Object> getEventLeftTop(IValueBinding<? extends MouseEventJsr> poEvent){
        return call(S, Object.class, "getEventLeftTop").with(poEvent);
    }

    public static JsFunc<Object> getEventLeftTop(org.eclipse.vjet.vsf.resource.html.event.handler.JsHandlerObjectEnum poEvent){
        return call(S, Object.class, "getEventLeftTop").with(poEvent);
    }

    public static JsFunc<Object> getEventLeftTop(){
        return call(S, Object.class, "getEventLeftTop").with(org.eclipse.vjet.vsf.resource.html.event.handler.JsHandlerObjectEnum.nativeEvent);
    }
