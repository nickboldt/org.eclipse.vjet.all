...
public interface ITransportJsr {
    JsObjData S = 
        new JsObjData("vjo.dsf.ITransport", ITransportJsr.class, "ITransport");
    ...
    public static JsTypeRef<ITransportJsr> prototype = new JsTypeRef<ITransportJsr>(S);
}