...
//NativeJsProxy for vjo.dsf.DefaultBinding.js
...
public class DefaultBinding extends NativeJsProxy implements IBinding {
    ...
    @AExclude
    public DefaultBinding(Scriptable nativeObj){
        super(nativeObj);
    }

    /** internal use only */
    protected DefaultBinding(Object ...args){
        super(args);
    }
    ...
    public final INativeJsFuncProxy<DefaultBinding> serialize = NativeJsFuncProxy.create(this, "serialize");

    public final INativeJsFuncProxy<DefaultBinding> deserialize = NativeJsFuncProxy.create(this, "deserialize");
}