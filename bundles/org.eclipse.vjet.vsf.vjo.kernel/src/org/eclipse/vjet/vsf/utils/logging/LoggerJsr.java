...
public class LoggerJsr extends JsObj {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("vjo.dsf.utils.logging.Logger", LoggerJsr.class, "Logger");
    ...
    protected LoggerJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
        super(cmpMeta, isInstance, args);
    }
    
    public static JsTypeRef<LoggerJsr> prototype = new JsTypeRef<LoggerJsr>(S);
}