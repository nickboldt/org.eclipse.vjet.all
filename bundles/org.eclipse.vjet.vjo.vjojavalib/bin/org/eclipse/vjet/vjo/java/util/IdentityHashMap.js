 ...
 *******************************************************************************/
vjo.ctype('org.eclipse.vjet.vjo.java.util.IdentityHashMap<K,V>') //< public
.needs(['org.eclipse.vjet.vjo.java.lang.IllegalArgumentException','org.eclipse.vjet.vjo.java.lang.System',
    'org.eclipse.vjet.vjo.java.lang.IllegalStateException','org.eclipse.vjet.vjo.java.util.Map','org.eclipse.vjet.vjo.java.util.NoSuchElementException',
    'org.eclipse.vjet.vjo.java.util.AbstractSet','org.eclipse.vjet.vjo.java.lang.Util','org.eclipse.vjet.vjo.java.lang.ObjectUtil'])
...
.props({
    ...
    .inherits('org.eclipse.vjet.vjo.java.util.IdentityHashMap.IdentityHashMapIterator<K,V,K>')
    .protos({
        //> public constructs(IdentityHashMap<K,V> map)
        constructs:function(map){
            this.base(map);
    ...
    .inherits('org.eclipse.vjet.vjo.java.util.IdentityHashMap.IdentityHashMapIterator<K,V,V>')
    .protos({
        //> public constructs(IdentityHashMap<K,V> map)
        constructs:function(map){
            this.base(map);
    ...
    .inherits('org.eclipse.vjet.vjo.java.util.IdentityHashMap.IdentityHashMapIterator<K,V,Map>')
    .satisfies('org.eclipse.vjet.vjo.java.util.Map<K,V>')
    .protos({
        //> public constructs(IdentityHashMap<K,V> map)
        constructs:function(map){
        ...
        equals:function(o){
            ...
            if(!(vjo.getType('org.eclipse.vjet.vjo.java.util.Map').clazz.isInstance(o))){
                return false;
            }
            var e=o;
...
.protos({
    ...
    equals_1_0_IdentityHashMap_ovld:function(o){
        if(o===this){
            ...
            return true;
        }else if(vjo.getType('org.eclipse.vjet.vjo.java.util.Map').clazz.isInstance(o)){
            var m=o;
