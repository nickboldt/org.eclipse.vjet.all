 ...
 *******************************************************************************/
vjo.ctype('org.eclipse.vjet.vjo.java.util.LinkedHashMap<K,V>') //< public
.needs(['org.eclipse.vjet.vjo.java.lang.IllegalStateException','org.eclipse.vjet.vjo.java.util.NoSuchElementException',
    'org.eclipse.vjet.vjo.java.lang.ObjectUtil'])
.needs('org.eclipse.vjet.vjo.java.util.Iterator','')
.needs('org.eclipse.vjet.vjo.java.util.ConcurrentModificationException','')
.inherits('org.eclipse.vjet.vjo.java.util.HashMap<K,V>')
...
.props({
    ...
    .inherits('org.eclipse.vjet.vjo.java.util.HashMap.Entry<K,V>')
    .protos({
...
.protos({
    ...
    .inherits('org.eclipse.vjet.vjo.java.util.LinkedHashMap.LinkedHashIterator<K, V, K>')
    .protos({
        //> public  constructs()
        constructs:function(map){
            this.base(map);
    ...
    .inherits('org.eclipse.vjet.vjo.java.util.LinkedHashMap.LinkedHashIterator<K, V, V>')
    .protos({
        //> public  constructs()
        constructs:function(map){
            this.base(map);
    ...
    .inherits('org.eclipse.vjet.vjo.java.util.LinkedHashMap.LinkedHashIterator<K, V, vjo.java.util.Map.Entry<K,V>>')
    .protos({
        //> public  constructs()
        constructs:function(map){
            this.base(map);
