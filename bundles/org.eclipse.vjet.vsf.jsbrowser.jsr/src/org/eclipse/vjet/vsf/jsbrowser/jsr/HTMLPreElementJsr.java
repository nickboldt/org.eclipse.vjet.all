...
public class HTMLPreElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLPreElement", HTMLPreElementJsr.class, "HTMLPreElement");

    public HTMLPreElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLPreElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLPreElementJsr> prototype = new JsTypeRef<HTMLPreElementJsr>(S);
}