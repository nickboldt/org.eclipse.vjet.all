...
public class HTMLDialogElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLDialogElement", HTMLDialogElementJsr.class, "HTMLDialogElement");

    public HTMLDialogElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLDialogElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLDialogElementJsr> prototype = new JsTypeRef<HTMLDialogElementJsr>(S);
}