...
public class HTMLBlockquoteElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLBlockquoteElement", HTMLBlockquoteElementJsr.class, "HTMLBlockquoteElement");

    public HTMLBlockquoteElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLBlockquoteElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLBlockquoteElementJsr> prototype = new JsTypeRef<HTMLBlockquoteElementJsr>(S);
}