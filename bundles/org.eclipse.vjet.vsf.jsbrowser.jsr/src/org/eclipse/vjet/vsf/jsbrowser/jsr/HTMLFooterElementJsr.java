...
public class HTMLFooterElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLFooterElement", HTMLFooterElementJsr.class, "HTMLFooterElement");

    public HTMLFooterElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLFooterElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLFooterElementJsr> prototype = new JsTypeRef<HTMLFooterElementJsr>(S);
}