...
public class HTMLBbElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLBbElement", HTMLBbElementJsr.class, "HTMLBbElement");

    public HTMLBbElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLBbElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLBbElementJsr> prototype = new JsTypeRef<HTMLBbElementJsr>(S);
}