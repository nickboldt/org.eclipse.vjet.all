...
public class HTMLUListElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLUListElement", HTMLUListElementJsr.class, "HTMLUListElement");

    public HTMLUListElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLUListElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLUListElementJsr> prototype = new JsTypeRef<HTMLUListElementJsr>(S);
}