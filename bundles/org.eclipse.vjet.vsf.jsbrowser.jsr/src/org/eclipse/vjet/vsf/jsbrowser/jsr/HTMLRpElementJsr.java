...
public class HTMLRpElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLRpElement", HTMLRpElementJsr.class, "HTMLRpElement");

    public HTMLRpElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLRpElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLRpElementJsr> prototype = new JsTypeRef<HTMLRpElementJsr>(S);
}