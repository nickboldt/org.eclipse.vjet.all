...
public class HTMLBElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLBElement", HTMLBElementJsr.class, "HTMLBElement");

    public HTMLBElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLBElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLBElementJsr> prototype = new JsTypeRef<HTMLBElementJsr>(S);
}