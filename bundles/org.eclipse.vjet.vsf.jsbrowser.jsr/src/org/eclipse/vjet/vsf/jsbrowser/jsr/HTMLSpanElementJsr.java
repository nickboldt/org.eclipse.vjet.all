...
public class HTMLSpanElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLSpanElement", HTMLSpanElementJsr.class, "HTMLSpanElement");

    public HTMLSpanElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLSpanElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLSpanElementJsr> prototype = new JsTypeRef<HTMLSpanElementJsr>(S);
}