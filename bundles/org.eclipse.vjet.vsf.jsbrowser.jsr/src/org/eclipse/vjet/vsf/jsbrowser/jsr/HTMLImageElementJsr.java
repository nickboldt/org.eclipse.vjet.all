...
public class HTMLImageElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLImageElement", HTMLImageElementJsr.class, "HTMLImageElement");

    public HTMLImageElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLImageElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLImageElementJsr> prototype = new JsTypeRef<HTMLImageElementJsr>(S);
}