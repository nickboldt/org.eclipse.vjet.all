...
public class HTMLDtElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLDtElement", HTMLDtElementJsr.class, "HTMLDtElement");

    public HTMLDtElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLDtElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLDtElementJsr> prototype = new JsTypeRef<HTMLDtElementJsr>(S);
}