...
public class HTMLKeyGenElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLKeyGenElement", HTMLKeyGenElementJsr.class, "HTMLKeyGenElement");

    public HTMLKeyGenElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLKeyGenElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
        super(cmpMeta, isInstance, args);
    }

    public JsProp<Boolean> autoFocus(){
        return getProp(Boolean.class, "autoFocus");
    }

    public IJsPropSetter autoFocus(boolean v) {
        return setProp("autoFocus", v);
    }

    public IJsPropSetter autoFocus(IValueBinding<Boolean> v) {
        return setProp("autoFocus", v);
    }

    public JsProp<Boolean> challenge(){
        return getProp(Boolean.class, "challenge");
    }

    public IJsPropSetter challenge(boolean v) {
        return setProp("challenge", v);
    }

    public IJsPropSetter challenge(IValueBinding<Boolean> v) {
        return setProp("challenge", v);
    }
    ...
    public JsProp<String> keyType(){
        return getProp(String.class, "keyType");
    }

    public IJsPropSetter keyType(String v) {
        return setProp("keyType", v);
    }

    public IJsPropSetter keyType(IValueBinding<String> v) {
        return setProp("keyType", v);
    }
    ...
    public static JsTypeRef<HTMLKeyGenElementJsr> prototype = new JsTypeRef<HTMLKeyGenElementJsr>(S);
}