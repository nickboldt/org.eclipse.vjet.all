...
public class HTMLButtonElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLButtonElement", HTMLButtonElementJsr.class, "HTMLButtonElement");

    public HTMLButtonElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLButtonElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLButtonElementJsr> prototype = new JsTypeRef<HTMLButtonElementJsr>(S);
}