...
public class HTMLHeadingElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLHeadingElement", HTMLHeadingElementJsr.class, "HTMLHeadingElement");

    public HTMLHeadingElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLHeadingElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLHeadingElementJsr> prototype = new JsTypeRef<HTMLHeadingElementJsr>(S);
}