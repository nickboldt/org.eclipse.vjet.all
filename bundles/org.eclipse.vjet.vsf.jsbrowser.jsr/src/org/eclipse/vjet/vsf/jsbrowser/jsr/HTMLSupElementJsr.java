...
public class HTMLSupElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLSupElement", HTMLSupElementJsr.class, "HTMLSupElement");

    public HTMLSupElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLSupElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLSupElementJsr> prototype = new JsTypeRef<HTMLSupElementJsr>(S);
}