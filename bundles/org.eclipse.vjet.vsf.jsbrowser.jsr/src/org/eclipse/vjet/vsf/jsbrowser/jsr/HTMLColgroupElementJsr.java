...
public class HTMLColgroupElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLColgroupElement", HTMLColgroupElementJsr.class, "HTMLColgroupElement");

    public HTMLColgroupElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLColgroupElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLColgroupElementJsr> prototype = new JsTypeRef<HTMLColgroupElementJsr>(S);
}