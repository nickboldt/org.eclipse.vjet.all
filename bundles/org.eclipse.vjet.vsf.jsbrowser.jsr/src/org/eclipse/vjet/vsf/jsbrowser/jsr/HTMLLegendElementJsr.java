...
public class HTMLLegendElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLLegendElement", HTMLLegendElementJsr.class, "HTMLLegendElement");

    public HTMLLegendElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLLegendElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLLegendElementJsr> prototype = new JsTypeRef<HTMLLegendElementJsr>(S);
}