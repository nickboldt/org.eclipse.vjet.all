...
public class HTMLOptGroupElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLOptGroupElement", HTMLOptGroupElementJsr.class, "HTMLOptGroupElement");

    public HTMLOptGroupElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLOptGroupElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLOptGroupElementJsr> prototype = new JsTypeRef<HTMLOptGroupElementJsr>(S);
}