...
public class CSSStyleRuleJsr extends CSSRuleJsr {
    ...
    private static final JsObjData S = 
        new JsObjData("CSSStyleRule", CSSStyleRuleJsr.class, "CSSStyleRule");

    public CSSStyleRuleJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected CSSStyleRuleJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<CSSStyleRuleJsr> prototype = new JsTypeRef<CSSStyleRuleJsr>(S);
}