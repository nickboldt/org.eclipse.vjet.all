...
public class HTMLEmElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLEmElement", HTMLEmElementJsr.class, "HTMLEmElement");

    public HTMLEmElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLEmElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLEmElementJsr> prototype = new JsTypeRef<HTMLEmElementJsr>(S);
}