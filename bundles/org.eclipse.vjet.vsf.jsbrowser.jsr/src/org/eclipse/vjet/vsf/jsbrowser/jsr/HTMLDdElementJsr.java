...
public class HTMLDdElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLDdElement", HTMLDdElementJsr.class, "HTMLDdElement");

    public HTMLDdElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLDdElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLDdElementJsr> prototype = new JsTypeRef<HTMLDdElementJsr>(S);
}