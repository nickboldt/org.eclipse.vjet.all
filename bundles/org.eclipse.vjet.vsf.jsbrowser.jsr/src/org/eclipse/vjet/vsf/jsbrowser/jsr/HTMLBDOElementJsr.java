...
public class HTMLBDOElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLBDOElement", HTMLBDOElementJsr.class, "HTMLBDOElement");

    public HTMLBDOElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLBDOElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLBDOElementJsr> prototype = new JsTypeRef<HTMLBDOElementJsr>(S);
}