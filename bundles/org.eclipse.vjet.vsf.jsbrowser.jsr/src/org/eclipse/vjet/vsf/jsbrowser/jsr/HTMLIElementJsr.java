...
public class HTMLIElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLIElement", HTMLIElementJsr.class, "HTMLIElement");

    public HTMLIElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLIElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLIElementJsr> prototype = new JsTypeRef<HTMLIElementJsr>(S);
}