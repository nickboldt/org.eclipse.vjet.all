...
public class HTMLTtElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLTtElement", HTMLTtElementJsr.class, "HTMLTtElement");

    public HTMLTtElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLTtElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLTtElementJsr> prototype = new JsTypeRef<HTMLTtElementJsr>(S);
}