...
public class HTMLMarkElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLMarkElement", HTMLMarkElementJsr.class, "HTMLMarkElement");

    public HTMLMarkElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLMarkElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLMarkElementJsr> prototype = new JsTypeRef<HTMLMarkElementJsr>(S);
}