...
public class HTMLAddressElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLAddressElement", HTMLAddressElementJsr.class, "HTMLAddressElement");

    public HTMLAddressElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLAddressElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLAddressElementJsr> prototype = new JsTypeRef<HTMLAddressElementJsr>(S);
}