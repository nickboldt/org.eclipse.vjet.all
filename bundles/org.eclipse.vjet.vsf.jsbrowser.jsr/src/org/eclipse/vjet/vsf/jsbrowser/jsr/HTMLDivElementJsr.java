...
public class HTMLDivElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLDivElement", HTMLDivElementJsr.class, "HTMLDivElement");

    public HTMLDivElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLDivElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLDivElementJsr> prototype = new JsTypeRef<HTMLDivElementJsr>(S);
}