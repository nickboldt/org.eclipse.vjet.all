...
public class HTMLStrongElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLStrongElement", HTMLStrongElementJsr.class, "HTMLStrongElement");

    public HTMLStrongElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLStrongElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLStrongElementJsr> prototype = new JsTypeRef<HTMLStrongElementJsr>(S);
}