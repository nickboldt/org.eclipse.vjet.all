...
public class HTMLArticleElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLArticleElement", HTMLArticleElementJsr.class, "HTMLArticleElement");

    public HTMLArticleElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLArticleElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public JsProp<String> pubDate(){
        return getProp(String.class, "pubDate");
    }

    public IJsPropSetter pubDate(String v) {
        return setProp("pubDate", v);
    }

    public IJsPropSetter pubDate(IValueBinding<String> v) {
        return setProp("pubDate", v);
    }
    ...
    public static JsTypeRef<HTMLArticleElementJsr> prototype = new JsTypeRef<HTMLArticleElementJsr>(S);
}