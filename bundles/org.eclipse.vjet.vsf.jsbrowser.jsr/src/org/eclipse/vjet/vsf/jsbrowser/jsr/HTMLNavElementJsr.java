...
public class HTMLNavElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLNavElement", HTMLNavElementJsr.class, "HTMLNavElement");

    public HTMLNavElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLNavElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLNavElementJsr> prototype = new JsTypeRef<HTMLNavElementJsr>(S);
}