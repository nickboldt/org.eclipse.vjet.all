...
public class HTMLFieldSetElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLFieldSetElement", HTMLFieldSetElementJsr.class, "HTMLFieldSetElement");

    public HTMLFieldSetElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLFieldSetElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLFieldSetElementJsr> prototype = new JsTypeRef<HTMLFieldSetElementJsr>(S);
}