...
public class HTMLVarElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLVarElement", HTMLVarElementJsr.class, "HTMLVarElement");

    public HTMLVarElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLVarElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLVarElementJsr> prototype = new JsTypeRef<HTMLVarElementJsr>(S);
}