...
public class HTMLAsideElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLAsideElement", HTMLAsideElementJsr.class, "HTMLAsideElement");

    public HTMLAsideElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLAsideElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLAsideElementJsr> prototype = new JsTypeRef<HTMLAsideElementJsr>(S);
}