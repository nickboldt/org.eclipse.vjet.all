...
public class HTMLBigElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLBigElement", HTMLBigElementJsr.class, "HTMLBigElement");

    public HTMLBigElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLBigElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLBigElementJsr> prototype = new JsTypeRef<HTMLBigElementJsr>(S);
}