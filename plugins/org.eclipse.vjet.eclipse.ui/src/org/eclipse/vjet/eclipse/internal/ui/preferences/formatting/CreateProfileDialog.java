...
public class CreateProfileDialog extends StatusDialog {
    ...
    private static final String PREF_OPEN_EDIT_DIALOG= VjetUIPlugin.PLUGIN_ID + ".codeformatter.create_profile_dialog.open_edit"; //$NON-NLS-1$
	...
	protected void okPressed() {
		...
		VjetUIPlugin.getDefault().getDialogSettings().put(PREF_OPEN_EDIT_DIALOG, fOpenEditDialog);
