...
public class LineWrappingTabPage extends FormatterTabPage {
	...
	private final static String PREF_CATEGORY_INDEX= VjetUIPlugin.PLUGIN_ID + "formatter_page.line_wrapping_tab_page.last_category_index"; //$NON-NLS-1$ 
...
//	);
	 ...
	 */
	private static final String PREF_PREVIEW_LINE_WIDTH= VjetPlugin.PLUGIN_ID + ".codeformatter.line_wrapping_tab_page.preview_line_width"; //$NON-NLS-1$
	...
	protected void forceSplitChanged(boolean forceSplit) {
        ...
        while (iterator.hasNext()) {
            ...
            try {
    			...
    			VjetUIPlugin.log(new Status(IStatus.ERROR, VjetUIPlugin.PLUGIN_ID, IStatus.OK, 
