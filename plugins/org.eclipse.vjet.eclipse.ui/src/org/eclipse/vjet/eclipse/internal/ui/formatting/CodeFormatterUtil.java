...
public class CodeFormatterUtil {
	...
	public static String evaluateFormatterEdit(String string, TextEdit edit, Position[] positions) {
		try {
			...
			VjetUIPlugin.log(e); // bug in the formatter
	...
	// TODO placeholder to implement js formatting
	public static TextEdit format2(int kJavaScript, String string, int offset,
			int length, StringBuffer computeIndentation,
			String defaultLineDelimiter, Map preferences) {
