...
import org.eclipse.vjet.eclipse.internal.formatter.comments.JavaDocRegion;
import org.eclipse.vjet.eclipse.internal.formatter.comments.MultiCommentRegion;
...
public class DefaultCodeFormatter extends CodeFormatter {
	...
	private static PublicScanner ProbingScanner;
...
//			this.options = VjetPlugin.getOptions();
	...
	private TextEdit probeFormatting(String source, int indentationLevel, String lineSeparator, int offset, int length) {
		if (ProbingScanner == null) {
			...
			ProbingScanner = new PublicScanner(true, true, false/*nls*/, ClassFileConstants.JDK1_3, ClassFileConstants.JDK1_3, null/*taskTags*/, null/*taskPriorities*/, true/*taskCaseSensitive*/);
		}
