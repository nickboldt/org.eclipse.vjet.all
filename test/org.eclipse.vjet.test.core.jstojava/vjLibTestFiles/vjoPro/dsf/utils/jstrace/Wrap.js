 ...
 ******************************************************************************/
vjo.ctype("vjoPro.dsf.utils.jstrace.Wrap") //<dynamic
.needs("vjoPro.dsf.utils.reflection.Reflection","R")
.props({

// expr could be:
// 0. for '.' to be part of regex, use '\.' in url / vm args or use '\\.' in
// java code
// 1. clz#func here, clz is the full name of a clz, func is represented in regex
// 2. clz.func here, clz is the full name of a clz, func is the full name of a
// func
wrap : function(expr, cfg){
var bf = cfg.beforeAct,
af = cfg.afterAct,
ex = t.R.escape(expr),
 ...
 * @JsJavaAccessToJs private This is the actual wrap util, the outgoing msg will
 *                   be constructred as the following [callee, function full
 * name, arguments, time @ browser]
 */
...
if(!this.vjoTraceId){
this.vjoTraceId = 'N/A'; // if the function is executed before the jsr
			    // instance is put into Registry
