...
public class TestHelper {
	...
	public String getExpectedVjo() {
		URL sourceUrl = JavaSourceLocator.getInstance().getSourceUrl(m_javaCls.getName(), ".vjo");
		System.out.println("found file:" + sourceUrl);
		return JavaSourceLocator.getInstance().getSource(sourceUrl);
...
//		return readFromFile(getFileName(m_javaCls, ".vjo"));
	...
	public String getExpectedJsr() {
		URL sourceUrl = JavaSourceLocator.getInstance().getSourceUrl(m_javaCls.getName(), ".jsr");
		System.out.println("found file:" + sourceUrl);
		return JavaSourceLocator.getInstance().getSource(sourceUrl);
...
//		return readFromFile(getFileName(m_javaCls, ".jsr"));
	...
	public static String getExpectedVjo(String srcName) {
		URL sourceUrl = JavaSourceLocator.getInstance().getSourceUrl(srcName, ".vjo");
		System.out.println("found file:" + sourceUrl);
		return JavaSourceLocator.getInstance().getSource(sourceUrl);
	}
