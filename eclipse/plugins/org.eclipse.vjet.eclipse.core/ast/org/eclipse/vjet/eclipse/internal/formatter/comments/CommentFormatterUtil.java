...
public class CommentFormatterUtil {
	...
	public static TextEdit format2(int kind, String string, int indentationLevel, String lineSeparator, Map options) {
		...
		return JSFormatterFactory.createCodeFormatter(options).format(kind, string, 0, length, indentationLevel, lineSeparator);
	}
	...
	public static void log(Throwable t) {
		VjetPlugin.error( "Exception occured while formatting comments",t); //$NON-NLS-1$
	}
}
