...
import org.eclipse.vjet.eclipse.internal.ui.preferences.formatting.SnippetPreview.PreviewSnippet;
...
public final class WhiteSpaceOptions {
	...
	public static class OptionNode extends Node {
        ...
        public void setChecked(boolean checked) {
        	fWorkingValues.put(fKey, checked ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
        }
        
        public boolean getChecked() {
            return VjetPlugin.INSERT.equals(fWorkingValues.get(fKey));
        }
