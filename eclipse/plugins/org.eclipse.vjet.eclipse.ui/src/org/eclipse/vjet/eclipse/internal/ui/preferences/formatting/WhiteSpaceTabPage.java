...
import org.eclipse.vjet.eclipse.internal.ui.preferences.formatting.WhiteSpaceOptions.InnerNode;
import org.eclipse.vjet.eclipse.internal.ui.preferences.formatting.WhiteSpaceOptions.Node;
import org.eclipse.vjet.eclipse.internal.ui.preferences.formatting.WhiteSpaceOptions.OptionNode;
...
public class WhiteSpaceTabPage extends FormatterTabPage {
	...
	private final class SyntaxComponent implements ISelectionChangedListener, ICheckStateListener, IDoubleClickListener {
	    ...
	    private final String PREF_NODE_KEY= VjetUIPlugin.PLUGIN_ID + "formatter_page.white_space_tab_page.node"; //$NON-NLS-1$
	...
	private final class JavaElementComponent implements ISelectionChangedListener, ICheckStateListener {
	    ...
	    private final String PREF_INNER_INDEX= VjetUIPlugin.PLUGIN_ID + "formatter_page.white_space.java_view.inner"; //$NON-NLS-1$ 
		private final String PREF_OPTION_INDEX= VjetUIPlugin.PLUGIN_ID + "formatter_page.white_space.java_view.option"; //$NON-NLS-1$
	...
	private final class SwitchComponent extends SelectionAdapter {
	    private final String PREF_VIEW_KEY= VjetUIPlugin.PLUGIN_ID + "formatter_page.white_space_tab_page.view"; //$NON-NLS-1$
