vjo.ctype('org.eclipse.vjet.vjo.java.lang.Long') //< public final
.needs(['org.eclipse.vjet.vjo.java.lang.NumberFormatException','org.eclipse.vjet.vjo.java.lang.Character',
    'org.eclipse.vjet.vjo.java.lang.Integer','org.eclipse.vjet.vjo.java.lang.Util',
    'org.eclipse.vjet.vjo.java.lang.StringUtil','org.eclipse.vjet.vjo.java.lang.NumberUtil'])
.needs('org.eclipse.vjet.vjo.java.lang.StringFactory','')
.inherits('org.eclipse.vjet.vjo.java.lang.Number')
.satisfies('org.eclipse.vjet.vjo.java.lang.Comparable<Long>')
.props({
    ...
    decode:function(nm){
        ...
        var negative=false;
        var result;
        if(org.eclipse.vjet.vjo.java.lang.StringUtil.startsWith(nm,"-")){
            negative=true;
            index++;
        }
        if(org.eclipse.vjet.vjo.java.lang.StringUtil.startsWith(nm,"0x",index) || org.eclipse.vjet.vjo.java.lang.StringUtil.startsWith(nm,"0X",index)){
            index+=2;
            radix=16;
        }else if(org.eclipse.vjet.vjo.java.lang.StringUtil.startsWith(nm,"#",index)){
            index++;
            radix=16;
        }else if(org.eclipse.vjet.vjo.java.lang.StringUtil.startsWith(nm,"0",index) && nm.length>1+index){
            index++;
            radix=8;
        }
        if(org.eclipse.vjet.vjo.java.lang.StringUtil.startsWith(nm,"-",index)){
...
.protos({
    ...
    toString:function(){
        return org.eclipse.vjet.vjo.java.lang.StringUtil._valueOf(this.value);
    },
    //> public int hashCode()
    hashCode:function(){
