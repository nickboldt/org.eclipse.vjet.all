...
vjo.ctype('org.eclipse.vjet.eclipse.javatojs.core.tests.codegen.java2js.data.Methods') //< public
.props({
    ...
    .inherits('org.eclipse.vjet.eclipse.javatojs.core.tests.codegen.java2js.data.Methods.TypeA')
    .protos({
        //> public constructs(final String name)
        constructs:function(name){
            this.base(name);
