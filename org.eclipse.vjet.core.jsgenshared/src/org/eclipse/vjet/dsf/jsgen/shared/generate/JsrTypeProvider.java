...
//		jsToJavaMapping.put("vjo.dsf.Event", createMapping(JS_HANDLER_OBJECT_ENUM));
		...
		jsToJavaMapping.put("vjo.Enum", createMapping("JsEnum",IClassR.JsEnum));
		jsToJavaMapping.put("Enum", createMapping("JsEnum", IClassR.JsEnum));
...
//		// artificial types
		...
		jsToJavaMapping.put("org.eclipse.vjet.dsf.jsnative.HtmlElement", 
				createMapping("org.eclipse.vjet.vsf.jsbrowser.jsr.HTMLElementJsr"));
		jsToJavaMapping.put("org.eclipse.vjet.dsf.jsnative.HtmlDocument", 
				createMapping("org.eclipse.vjet.vsf.jsbrowser.jsr.HTMLDocumentJsr"));
...
//	}
	...
	private void initPackageMapping() {
		...
		jsToJsrPackageMap.put("org.eclipse.vjet.dsf.jsnative.file",
				"org.eclipse.vjet.vsf.jsbrowser.jsr");
		jsToJsrPackageMap
				.put("org.eclipse.vjet.dsf.jsnative", "org.eclipse.vjet.vsf.jsbrowser.jsr");
