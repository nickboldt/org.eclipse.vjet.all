...
public class DecimalToHexJsr extends JsObj {
    ...
    private static final JsObjData S = 
        new JsObjData("vjo.dsf.utils.DecimalToHex", DecimalToHexJsr.class, "DecimalToHex");
    ...
    public static JsFunc<String> dec2Hex(String source){
        return call(S, String.class, "dec2Hex").with(source);
    }

    public static JsFunc<String> dec2Hex(IValueBinding<String> source){
        return call(S, String.class, "dec2Hex").with(source);
    }
