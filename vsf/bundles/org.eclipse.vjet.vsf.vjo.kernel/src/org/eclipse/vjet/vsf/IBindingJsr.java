...
public interface IBindingJsr {
    JsObjData S = 
        new JsObjData("vjo.dsf.IBinding", IBindingJsr.class, "IBinding");
    ...
    public static JsTypeRef<IBindingJsr> prototype = new JsTypeRef<IBindingJsr>(S);
}