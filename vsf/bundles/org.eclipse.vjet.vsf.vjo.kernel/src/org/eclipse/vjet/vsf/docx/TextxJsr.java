...
public class TextxJsr extends JsObj {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("vjo.dsf.docx.Textx", TextxJsr.class, "Textx");
    ...
    protected TextxJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<TextxJsr> prototype = new JsTypeRef<TextxJsr>(S);
}