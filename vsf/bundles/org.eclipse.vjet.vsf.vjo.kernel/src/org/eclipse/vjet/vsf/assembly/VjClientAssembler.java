...
//NativeJsProxy for vjo.dsf.assembly.VjClientAssembler.js
...
public class VjClientAssembler extends NativeJsProxy {
    ...
    @AExclude
    public VjClientAssembler(Scriptable nativeObj){
        super(nativeObj);
    }

    /** internal use only */
    protected VjClientAssembler(Object ...args){
        super(args);
    }
    ...
    public static String load(Object poRequest) {
        return callStaticWithName("vjo.dsf.assembly.VjClientAssembler", "load", String.class, poRequest);
    }

    public static void assemble() {
        callStaticWithName("vjo.dsf.assembly.VjClientAssembler", "assemble");
    }
