...
import org.eclipse.vjet.vjo.util.XmlVjoJsr;
...
public class XmlBindingJsr extends JsObj implements IBindingJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("vjo.dsf.XmlBinding", XmlBindingJsr.class, "XmlBinding");
    ...
    public static final IComponentSpec SPEC = S.getResourceSpec()
        ...
        .addDependentComponent(XmlVjoJsr.ResourceSpec.getInstance())
        .addDependentComponent(XmlJsonJsr.ResourceSpec.getInstance());

    public XmlBindingJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected XmlBindingJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<XmlBindingJsr> prototype = new JsTypeRef<XmlBindingJsr>(S);
}