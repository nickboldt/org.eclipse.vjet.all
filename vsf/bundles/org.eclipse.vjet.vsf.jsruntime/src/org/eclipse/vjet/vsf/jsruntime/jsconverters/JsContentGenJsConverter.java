...
public class JsContentGenJsConverter  extends BaseConverter<String>{

private static final List<Class> VALID_CONVERSION_TYPES ;
	
	static {
		final Class[] types = {
				IJsContentGenerator.class} ;
	...
	public IConversionResult<String> convert(Object toBeConverted) {
		IJsContentGenerator content = (IJsContentGenerator)toBeConverted;
		return setResult(toBeConverted, content.generate());
	}
