...
public class HTMLMapElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLMapElement", HTMLMapElementJsr.class, "HTMLMapElement");

    public HTMLMapElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLMapElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
        super(cmpMeta, isInstance, args);
    }

    public JsProp<HTMLCollectionJsr> areas(){
        return getProp(HTMLCollectionJsr.class, "areas");
    }

    public IJsPropSetter areas(HTMLCollectionJsr v) {
        return setProp("areas", v);
    }

    public IJsPropSetter areas(IValueBinding<? extends HTMLCollectionJsr> v) {
        return setProp("areas", v);
    }
    ...
    public static JsTypeRef<HTMLMapElementJsr> prototype = new JsTypeRef<HTMLMapElementJsr>(S);
}