...
public class HTMLRtElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLRtElement", HTMLRtElementJsr.class, "HTMLRtElement");

    public HTMLRtElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLRtElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLRtElementJsr> prototype = new JsTypeRef<HTMLRtElementJsr>(S);
}