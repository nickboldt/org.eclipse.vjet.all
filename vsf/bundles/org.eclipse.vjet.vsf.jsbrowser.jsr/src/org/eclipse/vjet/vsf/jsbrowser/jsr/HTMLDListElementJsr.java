...
public class HTMLDListElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLDListElement", HTMLDListElementJsr.class, "HTMLDListElement");

    public HTMLDListElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLDListElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLDListElementJsr> prototype = new JsTypeRef<HTMLDListElementJsr>(S);
}