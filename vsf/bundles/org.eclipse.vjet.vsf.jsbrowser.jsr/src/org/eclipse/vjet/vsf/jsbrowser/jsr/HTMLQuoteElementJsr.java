...
public class HTMLQuoteElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLQuoteElement", HTMLQuoteElementJsr.class, "HTMLQuoteElement");

    public HTMLQuoteElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLQuoteElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLQuoteElementJsr> prototype = new JsTypeRef<HTMLQuoteElementJsr>(S);
}