...
public class HTMLOutputElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLOutputElement", HTMLOutputElementJsr.class, "HTMLOutputElement");

    public HTMLOutputElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLOutputElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
        super(cmpMeta, isInstance, args);
    }

    public JsProp<String> for_(){
        return getProp(String.class, "for_");
    }

    public IJsPropSetter for_(String v) {
        return setProp("for_", v);
    }

    public IJsPropSetter for_(IValueBinding<String> v) {
        return setProp("for_", v);
    }

    public JsProp<String> form(){
        return getProp(String.class, "form");
    }

    public IJsPropSetter form(String v) {
        return setProp("form", v);
    }

    public IJsPropSetter form(IValueBinding<String> v) {
        return setProp("form", v);
    }
    ...
    public static JsTypeRef<HTMLOutputElementJsr> prototype = new JsTypeRef<HTMLOutputElementJsr>(S);
}