...
public class HTMLDetailsElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLDetailsElement", HTMLDetailsElementJsr.class, "HTMLDetailsElement");

    public HTMLDetailsElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLDetailsElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
        super(cmpMeta, isInstance, args);
    }

    public JsProp<Boolean> open(){
        return getProp(Boolean.class, "open");
    }

    public IJsPropSetter open(boolean v) {
        return setProp("open", v);
    }

    public IJsPropSetter open(IValueBinding<Boolean> v) {
        return setProp("open", v);
    }
    ...
    public static JsTypeRef<HTMLDetailsElementJsr> prototype = new JsTypeRef<HTMLDetailsElementJsr>(S);
}