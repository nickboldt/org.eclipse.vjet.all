...
public class HTMLDfnElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLDfnElement", HTMLDfnElementJsr.class, "HTMLDfnElement");

    public HTMLDfnElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLDfnElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLDfnElementJsr> prototype = new JsTypeRef<HTMLDfnElementJsr>(S);
}