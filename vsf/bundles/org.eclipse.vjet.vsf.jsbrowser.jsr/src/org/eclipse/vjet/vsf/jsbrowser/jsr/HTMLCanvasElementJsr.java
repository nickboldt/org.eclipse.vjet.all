...
public class HTMLCanvasElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLCanvasElement", HTMLCanvasElementJsr.class, "HTMLCanvasElement");

    public HTMLCanvasElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLCanvasElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public JsFunc<String> toDataURL(String type, Object... args){
        return call(String.class, "toDataURL").with(type, args);
    }

    public JsFunc<String> toDataURL(IValueBinding<String> type, IValueBinding<Object>... args){
        return call(String.class, "toDataURL").with(type, args);
    }

    public JsFunc<Object> getContext(String contextId, Object... args){
        return call(Object.class, "getContext").with(contextId, args);
    }

    public JsFunc<Object> getContext(IValueBinding<String> contextId, IValueBinding<Object>... args){
        return call(Object.class, "getContext").with(contextId, args);
    }
    
    public static JsTypeRef<HTMLCanvasElementJsr> prototype = new JsTypeRef<HTMLCanvasElementJsr>(S);
}