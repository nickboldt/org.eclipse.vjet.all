...
public class HTMLCommandElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLCommandElement", HTMLCommandElementJsr.class, "HTMLCommandElement");

    public HTMLCommandElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLCommandElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public JsProp<String> icon(){
        return getProp(String.class, "icon");
    }

    public IJsPropSetter icon(String v) {
        return setProp("icon", v);
    }

    public IJsPropSetter icon(IValueBinding<String> v) {
        return setProp("icon", v);
    }
    ...
    public JsProp<String> radioGroup(){
        return getProp(String.class, "radioGroup");
    }

    public IJsPropSetter radioGroup(String v) {
        return setProp("radioGroup", v);
    }

    public IJsPropSetter radioGroup(IValueBinding<String> v) {
        return setProp("radioGroup", v);
    }
    ...
    public static JsTypeRef<HTMLCommandElementJsr> prototype = new JsTypeRef<HTMLCommandElementJsr>(S);
}