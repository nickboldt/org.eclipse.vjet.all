...
public class HTMLSectionElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLSectionElement", HTMLSectionElementJsr.class, "HTMLSectionElement");

    public HTMLSectionElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLSectionElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLSectionElementJsr> prototype = new JsTypeRef<HTMLSectionElementJsr>(S);
}