...
public class HTMLDataListElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLDataListElement", HTMLDataListElementJsr.class, "HTMLDataListElement");

    public HTMLDataListElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLDataListElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLDataListElementJsr> prototype = new JsTypeRef<HTMLDataListElementJsr>(S);
}