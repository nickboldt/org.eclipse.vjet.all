...
public class HTMLSampElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLSampElement", HTMLSampElementJsr.class, "HTMLSampElement");

    public HTMLSampElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLSampElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLSampElementJsr> prototype = new JsTypeRef<HTMLSampElementJsr>(S);
}