...
public class HTMLSourceElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLSourceElement", HTMLSourceElementJsr.class, "HTMLSourceElement");

    public HTMLSourceElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLSourceElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLSourceElementJsr> prototype = new JsTypeRef<HTMLSourceElementJsr>(S);
}