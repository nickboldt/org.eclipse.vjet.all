...
public class HTMLRubyElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLRubyElement", HTMLRubyElementJsr.class, "HTMLRubyElement");

    public HTMLRubyElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLRubyElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLRubyElementJsr> prototype = new JsTypeRef<HTMLRubyElementJsr>(S);
}