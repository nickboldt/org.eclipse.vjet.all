...
public class HTMLKbdElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLKbdElement", HTMLKbdElementJsr.class, "HTMLKbdElement");

    public HTMLKbdElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLKbdElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLKbdElementJsr> prototype = new JsTypeRef<HTMLKbdElementJsr>(S);
}