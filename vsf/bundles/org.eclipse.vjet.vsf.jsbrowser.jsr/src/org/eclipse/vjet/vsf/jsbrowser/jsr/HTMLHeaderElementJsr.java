...
public class HTMLHeaderElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLHeaderElement", HTMLHeaderElementJsr.class, "HTMLHeaderElement");

    public HTMLHeaderElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLHeaderElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLHeaderElementJsr> prototype = new JsTypeRef<HTMLHeaderElementJsr>(S);
}