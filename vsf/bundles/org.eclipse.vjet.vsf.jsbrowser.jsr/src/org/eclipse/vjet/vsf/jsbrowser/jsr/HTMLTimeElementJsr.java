...
public class HTMLTimeElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLTimeElement", HTMLTimeElementJsr.class, "HTMLTimeElement");

    public HTMLTimeElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLTimeElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLTimeElementJsr> prototype = new JsTypeRef<HTMLTimeElementJsr>(S);
}