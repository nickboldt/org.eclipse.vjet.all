...
public class HTMLDataGridElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLDataGridElement", HTMLDataGridElementJsr.class, "HTMLDataGridElement");

    public HTMLDataGridElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLDataGridElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLDataGridElementJsr> prototype = new JsTypeRef<HTMLDataGridElementJsr>(S);
}