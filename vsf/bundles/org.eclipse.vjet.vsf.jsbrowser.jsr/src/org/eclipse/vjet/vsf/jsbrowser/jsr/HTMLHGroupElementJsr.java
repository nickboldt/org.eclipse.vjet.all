...
public class HTMLHGroupElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLHGroupElement", HTMLHGroupElementJsr.class, "HTMLHGroupElement");

    public HTMLHGroupElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLHGroupElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLHGroupElementJsr> prototype = new JsTypeRef<HTMLHGroupElementJsr>(S);
}