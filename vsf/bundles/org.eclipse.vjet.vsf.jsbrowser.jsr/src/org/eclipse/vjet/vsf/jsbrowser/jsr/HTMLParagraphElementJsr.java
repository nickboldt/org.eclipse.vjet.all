...
public class HTMLParagraphElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLParagraphElement", HTMLParagraphElementJsr.class, "HTMLParagraphElement");

    public HTMLParagraphElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLParagraphElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLParagraphElementJsr> prototype = new JsTypeRef<HTMLParagraphElementJsr>(S);
}