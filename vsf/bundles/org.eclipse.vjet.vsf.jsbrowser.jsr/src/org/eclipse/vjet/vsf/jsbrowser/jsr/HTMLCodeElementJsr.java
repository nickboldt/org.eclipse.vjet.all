...
public class HTMLCodeElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLCodeElement", HTMLCodeElementJsr.class, "HTMLCodeElement");

    public HTMLCodeElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLCodeElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLCodeElementJsr> prototype = new JsTypeRef<HTMLCodeElementJsr>(S);
}