...
public class HTMLProgressElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLProgressElement", HTMLProgressElementJsr.class, "HTMLProgressElement");

    public HTMLProgressElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLProgressElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLProgressElementJsr> prototype = new JsTypeRef<HTMLProgressElementJsr>(S);
}