...
public class HTMLFigureElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLFigureElement", HTMLFigureElementJsr.class, "HTMLFigureElement");

    public HTMLFigureElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLFigureElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLFigureElementJsr> prototype = new JsTypeRef<HTMLFigureElementJsr>(S);
}