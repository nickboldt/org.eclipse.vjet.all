...
public class HTMLCiteElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLCiteElement", HTMLCiteElementJsr.class, "HTMLCiteElement");

    public HTMLCiteElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLCiteElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLCiteElementJsr> prototype = new JsTypeRef<HTMLCiteElementJsr>(S);
}