...
public class HTMLSmallElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLSmallElement", HTMLSmallElementJsr.class, "HTMLSmallElement");

    public HTMLSmallElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLSmallElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLSmallElementJsr> prototype = new JsTypeRef<HTMLSmallElementJsr>(S);
}