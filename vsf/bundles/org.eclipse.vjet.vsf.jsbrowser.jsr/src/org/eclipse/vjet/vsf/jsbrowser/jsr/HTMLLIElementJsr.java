...
public class HTMLLIElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLLIElement", HTMLLIElementJsr.class, "HTMLLIElement");

    public HTMLLIElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLLIElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public JsProp<Integer> value(){
        return getProp(Integer.class, "value");
    }

    public IJsPropSetter value(int v) {
        return setProp("value", v);
    }

    public IJsPropSetter value(IValueBinding<Integer> v) {
        return setProp("value", v);
    }
    ...
    public static JsTypeRef<HTMLLIElementJsr> prototype = new JsTypeRef<HTMLLIElementJsr>(S);
}