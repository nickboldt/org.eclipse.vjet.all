...
import org.eclipse.vjet.vsf.jsbrowser.jsr.HTMLMediaElementJsr;
...
public class HTMLAudioElementJsr extends HTMLMediaElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLAudioElement", HTMLAudioElementJsr.class, "HTMLAudioElement");

    public HTMLAudioElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLAudioElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLAudioElementJsr> prototype = new JsTypeRef<HTMLAudioElementJsr>(S);
}