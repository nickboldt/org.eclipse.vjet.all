...
public class HTMLVideoElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLVideoElement", HTMLVideoElementJsr.class, "HTMLVideoElement");

    public HTMLVideoElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLVideoElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
        super(cmpMeta, isInstance, args);
    }

    public JsProp<Long> height(){
        return getProp(Long.class, "height");
    }

    public IJsPropSetter height(long v) {
        return setProp("height", v);
    }

    public IJsPropSetter height(IValueBinding<Long> v) {
        return setProp("height", v);
    }

    public JsProp<Long> width(){
        return getProp(Long.class, "width");
    }

    public IJsPropSetter width(long v) {
        return setProp("width", v);
    }

    public IJsPropSetter width(IValueBinding<Long> v) {
        return setProp("width", v);
    }

    public JsProp<Long> videoWidth(){
        return getProp(Long.class, "videoWidth");
    }

    public IJsPropSetter videoWidth(long v) {
        return setProp("videoWidth", v);
    }

    public IJsPropSetter videoWidth(IValueBinding<Long> v) {
        return setProp("videoWidth", v);
    }

    public JsProp<Long> videoHeight(){
        return getProp(Long.class, "videoHeight");
    }

    public IJsPropSetter videoHeight(long v) {
        return setProp("videoHeight", v);
    }

    public IJsPropSetter videoHeight(IValueBinding<Long> v) {
        return setProp("videoHeight", v);
    }

    public JsProp<String> poster(){
        return getProp(String.class, "poster");
    }

    public IJsPropSetter poster(String v) {
        return setProp("poster", v);
    }

    public IJsPropSetter poster(IValueBinding<String> v) {
        return setProp("poster", v);
    }
    ...
    public static JsTypeRef<HTMLVideoElementJsr> prototype = new JsTypeRef<HTMLVideoElementJsr>(S);
}