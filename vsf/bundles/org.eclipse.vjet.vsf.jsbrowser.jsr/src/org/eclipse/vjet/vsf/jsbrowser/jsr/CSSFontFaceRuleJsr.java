...
public class CSSFontFaceRuleJsr extends CSSRuleJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("CSSFontFaceRule", CSSFontFaceRuleJsr.class, "CSSFontFaceRule");

    public CSSFontFaceRuleJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected CSSFontFaceRuleJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<CSSFontFaceRuleJsr> prototype = new JsTypeRef<CSSFontFaceRuleJsr>(S);
}