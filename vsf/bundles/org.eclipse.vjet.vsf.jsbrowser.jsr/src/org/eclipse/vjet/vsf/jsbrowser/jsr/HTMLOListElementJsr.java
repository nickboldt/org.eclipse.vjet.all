...
public class HTMLOListElementJsr extends HTMLElementJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("HTMLOListElement", HTMLOListElementJsr.class, "HTMLOListElement");

    public HTMLOListElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLOListElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public JsProp<Integer> start(){
        return getProp(Integer.class, "start");
    }

    public IJsPropSetter start(int v) {
        return setProp("start", v);
    }

    public IJsPropSetter start(IValueBinding<Integer> v) {
        return setProp("start", v);
    }
    ...
    public static JsTypeRef<HTMLOListElementJsr> prototype = new JsTypeRef<HTMLOListElementJsr>(S);
}