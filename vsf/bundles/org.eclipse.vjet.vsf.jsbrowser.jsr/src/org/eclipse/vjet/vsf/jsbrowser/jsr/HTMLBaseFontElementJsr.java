...
public class HTMLBaseFontElementJsr extends HTMLElementJsr {
    ...
    private static final JsObjData S = 
        new JsObjData("HTMLBaseFontElement", HTMLBaseFontElementJsr.class, "HTMLBaseFontElement");

    public HTMLBaseFontElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLBaseFontElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<HTMLBaseFontElementJsr> prototype = new JsTypeRef<HTMLBaseFontElementJsr>(S);
}