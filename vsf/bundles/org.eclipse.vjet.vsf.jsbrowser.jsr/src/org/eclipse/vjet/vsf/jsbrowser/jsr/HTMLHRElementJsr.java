...
public class HTMLHRElementJsr extends HTMLElementJsr {
    ...
    private static final JsObjData S = 
        new JsObjData("HTMLHRElement", HTMLHRElementJsr.class, "HTMLHRElement");

    public HTMLHRElementJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected HTMLHRElementJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public IJsPropSetter noShade(boolean v) {
        return setProp("noShade", v);
    }

    public IJsPropSetter noShade(IValueBinding<Boolean> v) {
        return setProp("noShade", v);
    }
    ...
    public static JsTypeRef<HTMLHRElementJsr> prototype = new JsTypeRef<HTMLHRElementJsr>(S);
}